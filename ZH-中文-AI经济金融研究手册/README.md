...
英文版仍然是完整细节和持续更新的主版本。中文版的目标不是只翻译首页，而是让中文读者可以真正用中文阅读、复制、练习和教学。

| 阶段 | 优先内容 | 目标 |
| --- | --- | --- |
| 第一阶段 | 总导航、手册摘要、安全规则、Git/GitHub/Agent 设置、最常用技能概览 | 新读者可以用中文理解整个仓库 |
| 第二阶段 | 文献综述、实证方法、写作修改、代码调试、数据清洗、展示练习等常用 skill | 读者可以直接复制中文技能使用 |
| 第三阶段 | 完整案例、数据集访问说明、教学材料、双语 slides | 支持中文工作坊、RA 培训和课程使用 |
