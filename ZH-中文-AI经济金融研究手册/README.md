...
| 理解 Git、agent、MCP、branch、worktree 等技术词 | [01 技术词解释](01-从这里开始：AI经济金融研究手册.md#这些技术词在研究项目里是什么意思) |
...
| 功能/关键词 | 打开 |
| --- | --- |
| `写作`、`introduction`、`abstract`、`论文修改` | [02 复制即用：AI 研究指令与模板](02-复制即用：AI研究指令与模板.md) |
| `paper review`、`referee`、`R&R`、`审稿意见` | [02 复制即用：AI 研究指令与模板](02-复制即用：AI研究指令与模板.md) |
| `literature review`、`文献矩阵`、`citation` | [来源可靠的文献综述](02-复制即用：AI研究指令与模板.md#来源可靠的文献综述) |
| `Python`、`R`、`Stata`、`debug`、`代码检查` | [02 复制即用：AI 研究指令与模板](02-复制即用：AI研究指令与模板.md) |
| `DiD`、`IV`、`RD`、`panel`、`event study` | [因果识别诊断](02-复制即用：AI研究指令与模板.md#因果识别诊断) |
| `WRDS`、`CRSP`、`Compustat`、`数据合并` | [02 复制即用：AI 研究指令与模板](02-复制即用：AI研究指令与模板.md#数据清洗合并和输出工作流) |
| `agent`、`Codex`、`Claude Code`、`GitHub` | [03 设置 Agent 和自动化研究工作流](03-设置Agent和自动化研究工作流.md) |
| `dataset`、`资源`、`官方文档`、`找工具` | [05 资料来源、官方文档与更新](05-资料来源官方文档与更新.md) |
