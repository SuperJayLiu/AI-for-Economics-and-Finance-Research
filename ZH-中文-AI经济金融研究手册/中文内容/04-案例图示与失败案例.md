...
Output to audit:
If I have not provided the output, ask me to paste it or summarize it.

Project context:
If I have not provided the project context, ask me for the research question, data, method, and intended use.
