...
| Project | Persistent AI workspace for a paper, dataset, talk, or recurring task | [What Are AI Projects?](../03-How-to-Set-Up-Your-AI-Research-Workflow/ai-projects/00-what-are-ai-projects.md) |
...
| AGENTS.md | Project instruction file for coding agents | [Agent Instruction Files](../02-Copy-and-Use-AI-Research-Instructions-and-Templates/agent-instructions-files.md) |
| AI-use log | Record of AI-assisted tasks, accepted output, checks, and remaining uncertainty | [AI Use Log](../02-Copy-and-Use-AI-Research-Instructions-and-Templates/research-safety-and-git/08-ai-use-log.md) |
