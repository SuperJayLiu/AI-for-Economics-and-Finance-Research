...
本仓库适合希望 **点击、复制、粘贴、修改、核查** 的读者。它不是提示词合集，也不是 AI 工具清单。

主页尽量只保留主要阅读和工作文件夹。不需要普通读者反复查看的维护性文件和旧短页面，已集中放到 [Repository Reference and Maintenance](99-Repository-Reference-and-Maintenance/README.md)。

### 从这里开始

| 需求 | 打开 |
| --- | --- |
| 像读书一样学习核心概念 | [Start Here to Learn AI for Econ Finance Research](01-Start-Here-to-Learn-AI-for-Econ-Finance-Research/README.md) |
| 复制可直接使用的 instructions、skills、templates | [Copy and Use AI Research Instructions and Templates](02-Copy-and-Use-AI-Research-Instructions-and-Templates/README.md) |
| 搭建 agents 和自动化研究工作流 | [Set Up Agents and Automated Research Workflows](03-Set-Up-Agents-and-Automated-Research-Workflows/README.md) |
...
每个实用页面都应该尽量包含：可复制模块、需要输入什么、会产出什么、风险是什么、研究者必须人工核查什么。如果页面只是泛泛解释，应继续改成可以直接复制和使用的 skill、template、checklist、code block 或 example。

### 仓库结构

| 文件夹 | 用途 |
| --- | --- |
| [01-Start-Here-to-Learn-AI-for-Econ-Finance-Research](01-Start-Here-to-Learn-AI-for-Econ-Finance-Research/README.md) | 一个整合式手册，讲 AI 概念、风险、研究流程、实证、写作和自动化。 |
| [02-Copy-and-Use-AI-Research-Instructions-and-Templates](02-Copy-and-Use-AI-Research-Instructions-and-Templates/README.md) | 可直接复制使用的 AI 指令、skills、prompts、检查清单、研究日志、Git 安全规则。 |
| [03-Set-Up-Agents-and-Automated-Research-Workflows](03-Set-Up-Agents-and-Automated-Research-Workflows/README.md) | Git 设置、one-paper-one-repo、replication package、AI 更新 digest 等 agent 工作流。 |
| [04-See-Examples-Diagrams-and-Failure-Cases](04-See-Examples-Diagrams-and-Failure-Cases/README.md) | 例子、图示、失败案例和经济金融研究场景。 |
| [05-Check-Builders-Official-Docs-and-Resources](05-Check-Builders-Official-Docs-and-Resources/README.md) | 官方文档、外部来源、builder workflow 和资源筛选规则。 |
| [06-Teach-Workshops-Practice-Talks-and-Share-Slides](06-Teach-Workshops-Practice-Talks-and-Share-Slides/README.md) | 工作坊、课程材料、slide-ready 大纲、展示练习和 RA 培训。 |
| [99-Repository-Reference-and-Maintenance](99-Repository-Reference-and-Maintenance/README.md) | 引用、贡献、review 标准、changelog、roadmap 和旧页面归档。 |
